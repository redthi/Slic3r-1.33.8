...
our $alien_key = 'msw_3_0_3_uni_gcc_3_4';
...
sub _alien_path {
  ...
  return unless length 'msw_3_0_3_uni_gcc_3_4';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/msw_3_0_3_uni_gcc_3_4" ) {
      $wx_path = "$_/Alien/wxWidgets/msw_3_0_3_uni_gcc_3_4/lib";
      last;
    }
  }
}
