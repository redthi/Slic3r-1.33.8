...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEISCONN WSAEOPNOTSUPP WSAENOTEMPTY WSAEALREADY WSAEPROVIDERFAILEDINIT
	WSAENOTCONN WSAEBADF WSAEPFNOSUPPORT WSAEINPROGRESS WSAECONNABORTED
	WSAEPROTONOSUPPORT WSAEREMOTE WSAETIMEDOUT WSAEHOSTDOWN WSAENOTSOCK
	WSAEHOSTUNREACH WSAEINVALIDPROVIDER WSAESTALE WSAEINVALIDPROCTABLE
	WSAEREFUSED WSAECANCELLED WSAECONNRESET WSAEINVAL WSAEADDRINUSE
	WSAEPROCLIM WSAESHUTDOWN WSAENOMORE WSAEAFNOSUPPORT WSAEACCES
	WSAENOBUFS WSAEDISCON WSAELOOP WSAEPROTOTYPE WSAENETDOWN
	WSAETOOMANYREFS WSAEMFILE WSAEADDRNOTAVAIL WSAEDESTADDRREQ WSAEINTR
	WSAECONNREFUSED WSAEUSERS WSAEWOULDBLOCK WSAEMSGSIZE WSAEFAULT
	WSAEDQUOT WSAENETRESET WSAENOPROTOOPT WSAENETUNREACH
	WSAESOCKTNOSUPPORT WSAENAMETOOLONG
    )],
);
